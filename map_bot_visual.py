...
KODE_WILAYAH_KOTA = {
    # 11 - ACEH
    "1101": "ACEH SELATAN", "1102": "ACEH TENGGARA", "1103": "ACEH TIMUR", "1104": "ACEH TENGAH",
    "1105": "ACEH BARAT", "1106": "ACEH BESAR", "1107": "PIDIE", "1108": "BIREUEN",
    "1109": "ACEH UTARA", "1110": "ACEH BARAT DAYA", "1111": "GAYO LUES", "1112": "ACEH TAMIANG",
    "1113": "NAGAN RAYA", "1114": "ACEH JAYA", "1115": "BENER MERIAH", "1116": "PIDIE JAYA",
    "1171": "KOTA BANDA ACEH", "1172": "KOTA SABANG", "1173": "KOTA LHOKSEUMAWE", "1174": "KOTA LANGSA", "1175": "KOTA SUBULUSSALAM",

    # 12 - SUMATERA UTARA
    "1201": "TAPANULI TENGAH", "1202": "TAPANULI UTARA", "1203": "TAPANULI SELATAN", "1204": "NIAS",
    "1205": "LANGKAT", "1206": "KARO", "1207": "DELI SERDANG", "1208": "SIMALUNGUN",
    "1209": "ASAHAN", "1210": "LABUHANBATU", "1211": "DAIRI", "1212": "TOBA",
    "1213": "MANDAILING NATAL", "1214": "NIAS SELATAN", "1215": "PAKPAK BHARAT", "1216": "HUMBANG HASUNDUTAN",
    "1217": "SAMOSIR", "1218": "SERDANG BEDAGAI", "1219": "BATU BARA", "1220": "PADANG LAWAS UTARA",
    "1221": "PADANG LAWAS", "1222": "LABUHANBATU SELATAN", "1223": "LABUHANBATU UTARA", "1224": "NIAS UTARA", "1225": "NIAS BARAT",
    "1271": "KOTA MEDAN", "1272": "KOTA PEMATANGSIANTAR", "1273": "KOTA SIBOLGA", "1274": "KOTA TANJUNGBALAI",
    "1275": "KOTA BINJAI", "1276": "KOTA TEBING TINGGI", "1277": "KOTA PADANGSIDIMPUAN", "1278": "KOTA GUNUNGSITOLI",

    # 13 - SUMATERA BARAT
    "1301": "KEPULAUAN MENTAWAI", "1302": "PESISIR SELATAN", "1303": "SOLOK", "1304": "SIJUNJUNG",
    "1305": "TANAH DATAR", "1306": "PADANG PARIAMAN", "1307": "AGAM", "1308": "LIMA PULUH KOTA",
    "1309": "PASAMAN", "1310": "SOLOK SELATAN", "1311": "DHARMASRAYA", "1312": "PASAMAN BARAT",
    ...
    # 14 - RIAU
    "1401": "KUANTAN SINGINGI", "1402": "INDRAGIRI HULU", "1403": "INDRAGIRI HILIR", "1404": "PELALAWAN",
    "1405": "SIAK", "1406": "KAMPAR", "1407": "ROKAN HULU", "1408": "BENGKALIS",
    "1409": "ROKAN HILIR", "1410": "KEPULAUAN MERANTI", "1471": "KOTA PEKANBARU", "1472": "KOTA DUMAI",

    # 15 - JAMBI
    "1501": "KERINCI", "1502": "MERANGIN", "1503": "SAROLANGUN", "1504": "BATANGHARI",
    "1505": "MUARO JAMBI", "1506": "TANJUNG JABUNG BARAT", "1507": "TANJUNG JABUNG TIMUR", "1508": "TEBO",
    "1509": "BUNGO", "1571": "KOTA JAMBI", "1572": "KOTA SUNGAI PENUH",

    # 16 - SUMATERA SELATAN
    "1601": "OGAN KOMERING ULU", "1602": "OGAN KOMERING ILIR", "1603": "MUARA ENIM", "1604": "LAHAT",
    "1605": "MUSI RAWAS", "1606": "MUSI BANYUASIN", "1607": "BANYUASIN", "1608": "OGAN KOMERING ULU SELATAN",
    "1609": "OGAN KOMERING ULU TIMUR", "1610": "OGAN ILIR", "1611": "EMPAT LAWANG", "1612": "PENUKAL ABAB LEMATANG ILIR",
    "1613": "MUSI RAWAS UTARA", "1671": "KOTA PALEMBANG", "1672": "KOTA PAGAR ALAM", "1673": "KOTA LUBUKLINGGAU", "1674": "KOTA PRABUMULIH",

    # 17 - BENGKULU
    "1701": "BENGKULU SELATAN", "1702": "REJANG LEBONG", "1703": "BENGKULU UTARA", "1704": "KAUR",
    "1705": "SELUMA", "1706": "MUKOMUKO", "1707": "LEBONG", "1708": "KEPAHIANG", "1709": "BENGKULU TENGAH", "1771": "KOTA BENGKULU",

    # 18 - LAMPUNG
    "1801": "LAMPUNG BARAT", "1802": "TANGGAMUS", "1803": "LAMPUNG SELATAN", "1804": "LAMPUNG TIMUR",
    "1805": "LAMPUNG TENGAH", "1806": "LAMPUNG UTARA", "1807": "WAY KANAN", "1808": "TULANG BAWANG",
    "1809": "PESAWARAN", "1810": "PRINGSEWU", "1811": "MESUJI", "1812": "TULANG BAWANG BARAT",
    ...
    "1905": "BANGKA SELATAN", "1906": "BELITUNG TIMUR", "1971": "KOTA PANGKALPINANG",

    # 21 - KEPULAUAN RIAU
    "2101": "KARIMUN", "2102": "BINTAN", "2103": "NATUNA", "2104": "LINGGA",
    "2105": "KEPULAUAN ANAMBAS", "2171": "KOTA BATAM", "2172": "KOTA TANJUNGPINANG",
    ...
    "3217": "BANDUNG BARAT", "3218": "PANGANDARAN", "3271": "KOTA BOGOR", "3272": "KOTA SUKABUMI",
    ...
    "3329": "BREBES", "3371": "KOTA MAGELANG", "3372": "KOTA SURAKARTA", "3373": "KOTA SALATIGA",
    ...
    "5201": "LOMBOK BARAT", "5202": "LOMBOK TENGAH", "5203": "LOMBOK TIMUR", "5204": "SUMBAWA",
    "5205": "DOMPU", "5206": "BIMA", "5207": "SUMBAWA BARAT", "5208": "LOMBOK UTARA",
    ...
    "5313": "MANGGARAI", "5314": "ROTE NDAO", "5315": "MANGGARAI BARAT", "5316": "SUMBA TENGAH",
    "5317": "SUMBA BARAT DAYA", "5318": "NAGEKEO", "5319": "MANGGARAI TIMUR", "5320": "SABU RAIJUA",
    "5321": "MALAKA", "5371": "KOTA KUPANG",
    ...
    "6201": "KOTAWARINGIN BARAT", "6202": "KOTAWARINGIN TIMUR", "6203": "KAPUAS", "6204": "BARITO SELATAN",
    "6205": "BARITO UTARA", "6206": "SUKAMARA", "6207": "LAMANDAU", "6208": "SERUYAN",
    "6209": "KATINGAN", "6210": "PULANG PISAU", "6211": "GUNUNG MAS", "6212": "BARITO TIMUR",
    "6213": "MURUNG RAYA", "6271": "KOTA PALANGKA RAYA",

    # 63 - KALIMANTAN SELATAN
    "6301": "TANAH LAUT", "6302": "KOTABARU", "6303": "BANJAR", "6304": "BARITO KUALA",
    "6305": "TAPIN", "6306": "HULU SUNGAI SELATAN", "6307": "HULU SUNGAI TENGAH", "6308": "HULU SUNGAI UTARA",
    "6309": "TABALONG", "6310": "TANAH BUMBU", "6311": "BALANGAN", "6371": "KOTA BANJARMASIN", "6372": "KOTA BANJARBARU",

    # 64 - KALIMANTAN TIMUR
    "6401": "PASER", "6402": "KUTAI BARAT", "6403": "KUTAI KARTANEGARA", "6404": "KUTAI TIMUR",
    "6405": "BERAU", "6409": "PENAJAM PASER UTARA", "6411": "MAHAKAM ULU", "6471": "KOTA BALIKPAPAN",
    "6472": "KOTA SAMARINDA", "6474": "KOTA BONTANG",

    # 65 - KALIMANTAN UTARA
    "6501": "MALINAU", "6502": "BULUNGAN", "6503": "TANA TIDUNG", "6504": "NUNUKAN", "6571": "KOTA TARAKAN",

    # 71 - SULAWESI UTARA
    "7101": "BOLAANG MONGONDOW", "7102": "MINAHASA", "7103": "KEPULAUAN SANGIHE", "7104": "KEPULAUAN TALAUD",
    "7105": "MINAHASA SELATAN", "7106": "MINAHASA UTARA", "7107": "BOLAANG MONGONDOW UTARA", "7108": "SIAU TAGULANDANG BIARO",
    "7109": "MINAHASA TENGGARA", "7110": "BOLAANG MONGONDOW SELATAN", "7111": "BOLAANG MONGONDOW TIMUR",
    "7171": "KOTA MANADO", "7172": "KOTA BITUNG", "7173": "KOTA TOMOHON", "7174": "KOTA KOTAMOBAGU",

    # 72 - SULAWESI TENGAH
    "7201": "BANGGAI KEPULAUAN", "7202": "BANGGAI", "7203": "MOROWALI", "7204": "POSO",
    "7205": "DONGGALA", "7206": "TOLITOLI", "7207": "BUOL", "7208": "PARIGI MOUTONG",
    "7209": "TOJO UNA-UNA", "7210": "SIGI", "7211": "BANGGAI LAUT", "7212": "MOROWALI UTARA", "7271": "KOTA PALU",
    ...
    "7317": "LUWU", "7318": "TANA TORAJA", "7322": "LUWU UTARA", "7324": "LUWU TIMUR",
    "7326": "TORAJA UTARA", "7371": "KOTA MAKASSAR", "7372": "KOTA PAREPARE", "7373": "KOTA PALOPO",

    # 74 - SULAWESI TENGGARA
    "7401": "BUTON", "7402": "MUNA", "7403": "KONAWE", "7404": "KOLAKA",
    "7405": "KONAWE SELATAN", "7406": "BOMBANA", "7407": "WAKATOBI", "7408": "KOLAKA UTARA",
    "7409": "BUTON UTARA", "7410": "KONAWE UTARA", "7411": "KOLAKA TIMUR", "7412": "KONAWE KEPULAUAN",
    "7413": "MUNA BARAT", "7414": "BUTON TENGAH", "7415": "BUTON SELATAN", "7471": "KOTA KENDARI", "7472": "KOTA BAUBAU",

    # 75 - GORONTALO
    "7501": "BOALEMO", "7502": "GORONTALO", "7503": "POHUWATO", "7504": "BONE BOLANGO",
    "7505": "GORONTALO UTARA", "7571": "KOTA GORONTALO",

    # 76 - SULAWESI BARAT
    "7601": "PASANGKAYU", "7602": "MAMUJU", "7603": "MAMASA", "7604": "POLEWALI MANDAR",
    "7605": "MAJENE", "7606": "MAMUJU TENGAH",

    # 81 - MALUKU
    "8101": "KEPULAUAN TANIMBAR", "8102": "MALUKU TENGGARA", "8103": "MALUKU TENGAH", "8104": "BURU",
    "8105": "KEPULAUAN ARU", "8106": "SERAM BAGIAN BARAT", "8107": "SERAM BAGIAN TIMUR", "8108": "MALUKU BARAT DAYA",
    "8109": "BURU SELATAN", "8171": "KOTA AMBON", "8172": "KOTA TUAL",

    # 82 - MALUKU UTARA
    "8201": "HALMAHERA BARAT", "8202": "HALMAHERA TENGAH", "8203": "KEPULAUAN SULA", "8204": "HALMAHERA SELATAN",
    "8205": "HALMAHERA UTARA", "8206": "HALMAHERA TIMUR", "8207": "PULAU MOROTAI", "8208": "PULAU TALIABU",
    "8271": "KOTA TERNATE", "8272": "KOTA TIDORE KEPULAUAN",

    # 91 - PAPUA & PROVINSI PEMEKARAN
    "9101": "MERAUKE", "9102": "JAYAWIJAYA", "9103": "JAYAPURA", "9104": "NABIRE",
    "9105": "KEPULAUAN YAPEN", "9106": "BIAK NUMFOR", "9107": "PANIAI", "9108": "PUNCAK JAYA",
    "9109": "MIMIKA", "9110": "BOVEN DIGOEL", "9111": "MAPPI", "9112": "ASMAT",
    "9113": "YAHUKIMO", "9114": "PEGUNUNGAN BINTANG", "9115": "TOLIKARA", "9116": "SARMI",
    "9117": "KEEROM", "9118": "WAROPEN", "9119": "SUPIORI", "9120": "MAMBERAMO RAYA",
    "9121": "NDUGA", "9122": "LANNY JAYA", "9123": "MAMBERAMO TENGAH", "9124": "YALIMO",
    "9125": "PUNCAK", "9126": "DOGIYAI", "9127": "INTAN JAYA", "9128": "DEIYAI", "9171": "KOTA JAYAPURA",

    # 92 - PAPUA BARAT & PAPUA BARAT DAYA
    "9201": "SORONG", "9202": "MANOKWARI", "9203": "FAKFAK", "9204": "SORONG SELATAN",
    "9205": "RAJA AMPAT", "9206": "TELUK BINTUNI", "9207": "TELUK WONDAMA", "9208": "KAIMANA",
    "9209": "TAMBRAUW", "9210": "MAYBRAT", "9211": "MANOKWARI SELATAN", "9212": "PEGUNUNGAN ARFAK", "9271": "KOTA SORONG"
}
