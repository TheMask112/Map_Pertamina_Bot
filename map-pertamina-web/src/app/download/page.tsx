...
export default function DownloadPage() {
  ...
  const androidDownloadUrl = process.env.NEXT_PUBLIC_ANDROID_DOWNLOAD_URL || 'https://github.com/TheMask112/Map_Pertamina_Bot/releases/download/v1.1.1/MAP_Pertamina_Bot_v1.1.1.apk';
    ...
    <div style={styles.container} className="animate-fade-in">
      ...
      <div style={styles.header}>
        ...
        <p style={styles.subtitle}>
          Unduh aplikasi resmi <strong>v1.1.1</strong> dan pelajari panduan visual mandiri dari awal hingga mahir.
        </p>
      </div>
